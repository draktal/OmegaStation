server-currency-name-singular = Омега Коин
server-currency-name-plural = Омега Коины
...
gs-balanceui-shop-label = Магазин Омега Стейшена
...
gs-balanceui-shop-buy-token-hightier-antag = Купить хайтир антаг токен - { $price } Омега Коинов
gs-balanceui-shop-buy-token-midtier-antag = Купить мидтир антаг токен - { $price } Омега Коинов
gs-balanceui-shop-buy-token-admin = Купить должность младшего игрового модератора - { $price } Омега Коинов
gs-balanceui-shop-buy-token-antag = Купить антаг токен - { $price } Омега Коинов
gs-balanceui-shop-buy-token-lowtier-antag = Купить лоутир - { $price } Омега Коинов
gs-balanceui-shop-buy-token-hat = Купить токен на шляпу - { $price } Омега Коинов
gs-balanceui-shop-token-admin = Младший игровой модератор (НЕ ПОКУПАТЬ)
gs-balanceui-shop-token-antag = Хайтир антаг токен
gs-balanceui-shop-buy-token-admin-abuse = Купить админ абуз токен - { $price } Омега Коинов
gs-balanceui-shop-token-hat = Жетон шляпы
gs-balanceui-shop-buy-token-admin-desc = Станьте младшим игровым модератором на сервере. (НЕ ПОКУПАТЬ)
gs-balanceui-shop-buy-token-antag-desc = Позволяет вам стать любым антагонистом. (За исключением волшебника)
gs-balanceui-shop-buy-token-ghost = Купить гостроль токен - { $price } Омега Коинов
